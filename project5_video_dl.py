...
def search_windows(img, windows, color_space='RGB', 
    ...
    for window in windows:
        ...
        image_array = np.asarray(test_img)
...
def find_cars(image):
    ...
    hot_windows88 = search_windows(image, windows, color_space=color_space, 
    ...
    hot_windows96 = search_windows(image, windows, color_space=color_space, 
                            spatial_size=spatial_size, hist_bins=hist_bins, 
                            orient=orient, pix_per_cell=pix_per_cell, 
                            cell_per_block=cell_per_block, 
                            hog_channel=hog_channel, spatial_feat=spatial_feat, 
    ...
    hot_windows128 = search_windows(image, windows, color_space=color_space, 
                            spatial_size=spatial_size, hist_bins=hist_bins, 
                            orient=orient, pix_per_cell=pix_per_cell, 
                            cell_per_block=cell_per_block, 
                            hog_channel=hog_channel, spatial_feat=spatial_feat, 
